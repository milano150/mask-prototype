...
try:
    if title_path:
        ...
        print("⚠️ No title font found in assets; using system font.")
    ...
    if sub_path:
        ...
        print("ℹ️ Using title font for UI labels since no sub-title font was found.")
    else:
        BTN_FONT = pygame.font.SysFont("timesnewroman", 30, bold=True)
        HS_FONT = pygame.font.SysFont("timesnewroman", 22, bold=True)
        print("⚠️ No sub-title font found in assets; using system fonts.")
except Exception as e:
    print("⚠️ Error loading fonts from assets, falling back to system fonts:", e)
    TITLE_FONT = pygame.font.SysFont("timesnewroman", 64, bold=True)
    BTN_FONT = pygame.font.SysFont("timesnewroman", 30, bold=True)
    HS_FONT = pygame.font.SysFont("timesnewroman", 22, bold=True)
...
def main_menu():
    ...
    # persistently loaded high score
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if buttons[0].rect.collidepoint(mouse):
                    show_modal("NEW GAME", "New Game exists", duration=1200)
